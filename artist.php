  ...
  <body>
    ...
    <div class="container">
      ...
      <?php
        ...
        $query="SELECT albid, albname FROM Albums WHERE artid = '".$artid."'";
        $result=$connection->query($query);
        
        echo '<br><p><b>Location: </b>'.$location.'</p><br>';
        echo '<p>Albums:</p>';
        while($row=$result->fetch_array(MYSQLI_NUM)){
          echo "<p><a href=/php-wrapper/adh/album.php?albid=$row[0]>$row[1]</a></p>";
        }
      ?>
      </div>
      <div class="footer">
